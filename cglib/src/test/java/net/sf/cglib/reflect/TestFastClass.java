...
public class TestFastClass extends net.sf.cglib.CodeGenTestCase {
    ...
    public void testGetMethod() throws Exception {
        ...
        FastMethod method = fc.getMethod(Base.class.getDeclaredMethod("foo", new Class[] { String.class }));
    ...
    public void testGetMethod_covarientOverride() throws Exception {
        ...
        FastMethod method = fc.getMethod(Sub.class.getDeclaredMethod("foo", new Class[] { String.class }));
