...
public class TestEnhancer extends CodeGenTestCase {
    ...
    public void testProxyClassReuseAcrossGC() throws InterruptedException {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            if (proxyClassName == null) {
                ...
                assertEquals("GC iteration " + i + ", proxy class should survive GC and be reused even across GC", proxyClassName, actualProxyClassName);
            }
            System.gc();
        }
    }
    ...
    private static class TestFilter implements CallbackFilter {
        ...
        @Override
        public int hashCode() {
            // Make sure Enhancer uses equals, not just hashCode alone
            return 1;
        }
    ...
    public void testBridgeParameterCheckcast() throws Exception {
        ...
        final Map<String, byte[]> classes = new HashMap<String, byte[]>();
        {
            ...
            cw.visit(49, Opcodes.ACC_PUBLIC | Opcodes.ACC_ABSTRACT | Opcodes.ACC_INTERFACE, "I", "<A:Ljava/lang/Object;B:Ljava/lang/Object;>Ljava/lang/Object;", "java/lang/Object", null);
            {
                MethodVisitor mv = cw.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_ABSTRACT, "f", "(Ljava/lang/Object;)Ljava/lang/Object;", "(TB;)TA;", null);
                mv.visitEnd();
            }
            cw.visitEnd();
        ...
        {
            ClassWriter cw = new ClassWriter(0);
            cw.visit(49, Opcodes.ACC_PUBLIC | Opcodes.ACC_SUPER | Opcodes.ACC_ABSTRACT, "Z", "<U:Ljava/lang/Number;>Ljava/lang/Object;LI<TU;Ljava/lang/String;>;", "java/lang/Object", new String[] { "I" });
            {
            ...
            {
                MethodVisitor mv = cw.visitMethod(Opcodes.ACC_PUBLIC, "f", "(Ljava/lang/String;)Ljava/lang/Number;", "(Ljava/lang/String;)TU;", null);
                mv.visitCode();
        ...
        }
        {
            ...
            {
                MethodVisitor mv = cw.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_BRIDGE | Opcodes.ACC_SYNTHETIC, "f", "(Ljava/lang/Object;)Ljava/lang/Object;", null, null);
                mv.visitCode();
                mv.visitVarInsn(Opcodes.ALOAD, 0);
                mv.visitVarInsn(Opcodes.ALOAD, 1);
                mv.visitTypeInsn(Opcodes.CHECKCAST, "java/lang/String");
                mv.visitMethodInsn(Opcodes.INVOKESPECIAL, "Z", "f", "(Ljava/lang/String;)Ljava/lang/Number;", false);
                mv.visitInsn(Opcodes.ARETURN);
                mv.visitMaxs(2, 2);
                mv.visitEnd();
            }
    ...
    public void testInterfaceBridge() throws Exception {
        ...
        final Map<String, byte[]> classes = new HashMap<String, byte[]>();
        {
            ...
            classWriter.visit(Opcodes.V1_8, Opcodes.ACC_ABSTRACT | Opcodes.ACC_INTERFACE | Opcodes.ACC_PUBLIC, "A", "<T:Ljava/lang/Object;>Ljava/lang/Object;", "java/lang/Object", null);
            MethodVisitor methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_ABSTRACT, "f", "(Ljava/lang/Object;)V", "(TT;)V", null);
        ...
        {
            ClassWriter classWriter = new ClassWriter(0);
            classWriter.visit(Opcodes.V1_8, Opcodes.ACC_ABSTRACT | Opcodes.ACC_INTERFACE | Opcodes.ACC_PUBLIC, "B", "<T:Ljava/lang/Number;>Ljava/lang/Object;LA<TT;>;", "java/lang/Object", new String[] { "A" });
            {
                MethodVisitor methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_ABSTRACT, "f", "(Ljava/lang/Number;)V", "(TT;)V", null);
                methodVisitor.visitEnd();
            }
            {
                MethodVisitor methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_BRIDGE | Opcodes.ACC_SYNTHETIC, "f", "(Ljava/lang/Object;)V", null, null);
    ...
    public interface // the usage of the interface forces the bridge
    Interface {
